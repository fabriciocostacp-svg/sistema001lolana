-- =============================================================================
-- INSTALAR LOGIN NO BANCO — cole no Supabase → SQL Editor → Run
--
-- Cria: funcionarios, sessions, password_resets, login_attempts
-- Cria/atualiza usuário: lolana com TODAS as permissões + senha bcrypt
--
-- Login após rodar:
--   Usuário: lolana
--   Senha:   1234
-- (senha fraca — troque em produção pelo app ou altere o crypt(...) abaixo)
-- =============================================================================
...
-- Usuário admin com todas as permissões (lolana / 1234 em bcrypt)
