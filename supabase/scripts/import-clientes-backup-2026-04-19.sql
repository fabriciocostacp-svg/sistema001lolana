-- Coloca no banco todos os clientes do backup backup_clientes_2026-04-19.csv (66 linhas).
-- Supabase: SQL Editor, execute o arquivo inteiro.
-- session_replication_role=replica na transacao mantem numeros do backup (001, 012, 070, etc.).
-- Se ja existir cliente com o mesmo numero, atualiza dados (upsert por numero).
-- Dica: se houver pedidos de teste ligados ao mesmo numero de outro cadastro, revise antes.
...
VALUES
  ...
  ('064', 'Fabricio Costa Cyrillo Pereira', '19999717781', 'Itirapina', '32247119816', NULL, '2026-04-02T03:34:25.234471+00:00'::timestamptz),
  ('065', 'Grazieli', '19999058941', 'Santa Cruz', NULL, NULL, '2026-04-08T13:52:31.759819+00:00'::timestamptz),
  ('066', 'Elvis Onning', '19981409992', 'avenida 3, 469', NULL, NULL, '2026-04-10T17:02:19.870141+00:00'::timestamptz),
  ('067', 'Lúcia', '19997886558', 'Jd Vale Verde', NULL, NULL, '2026-04-10T17:42:28.307138+00:00'::timestamptz),
  ('068', 'Cristina', '19996686050', 'Caiapos 353', NULL, NULL, '2026-04-16T12:28:25.07385+00:00'::timestamptz),
  ('069', 'Bruna Silva', '16997197972', 'Centro', NULL, NULL, '2026-04-16T12:39:12.803755+00:00'::timestamptz),
  ('070', 'leonardo curatito', '19999717781', 'rua jose grossi | CEP: 13531-158', '32247119816', NULL, '2026-04-19T15:07:07.744774+00:00'::timestamptz)
